...
namespace ToyEngine
{
	...
	{
		// Get the index of the "ViewProjectMats" uniform block in each shader program.
		...
		// This tells OpenGL that the "ViewProjectMats" block in each shader will use binding point 0.
